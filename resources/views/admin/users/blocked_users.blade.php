                        ...
                        <tbody>
                            @foreach($users as $key => $val)
                                <tr>
                                    ...
                                    <td>{{$val->user_premium == '2' ? 'Available' : '-'}}</td>
                                    <td class="p-l-0 p-r-0 action">
                                        <a href="javascript:void(0)" class="btn btn-success gold-b approveUser" data-id="{{base64_encode($val->id)}}"><i class="fa fa-check-circle"></i> </a>                 
                                    </td>                                                
                                </tr>
                            @endforeach                                           
                        </tbody>
